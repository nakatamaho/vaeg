...
static const BYTE EXCV_GMRESET[] = {0xf0, 0x7e, 0x7f, 0x09, 0x01, 0xf7};
...
static const BYTE midictrltbl[] = {0,  1,  5,  7, 10, 11, 64, 65, 66, 67, 84, 91, 93,
                                   94,              // for SC-88
                                   71, 72, 73, 74}; // for XG
...
static VAEG_INTPTR midimsg(COMMNG self, UINT msg, VAEG_INTPTR param) {
	...
	case COMMSG_SETFLAG:
		flag = (COMFLAG)param;
		if ((flag) && (flag->size == sizeof(_COMFLAG) + sizeof(midi->mch)) &&
