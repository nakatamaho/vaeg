...
| M89 | tasks/M89_merge_va_source_directories.md | Consolidate the active VA BIOS, VRAM, and CPU adapter/backend directories into `bios/`, `vram/`, and `cpu/` without behavior change | **G89 human gate passed; M89 closed at [665877a](https://github.com/nakatamaho/vaeg/commit/665877ab7e0961907a255796b30e7438115c6e51); Hosted CI [31577266904](https://github.com/nakatamaho/vaeg/actions/runs/31577266904) passed** |
| M90 | tasks/M90_va_ems_board.md | Enable the retained VA EMS page-frame board with 1MB capacity units, GUI/configuration support, and an EMMVA/RDEMS supplemental-disk workflow | **G90 human pending at [b437811](https://github.com/nakatamaho/vaeg/commit/b4378111319fe0a82e31abebc4b4749df2083dc0)** |
...
-
  ...
  G89 human validation on 2026-08-12; M89 is closed and authorized for
...
M89 is closed after G89 human validation of the source-directory
...
in 1MB units. It also installs the redistributable EMMVA adapter and dependent
RDEMS utility in the generated supplemental-disk workflow while requiring the
user to supply a compatible EMM manager separately. M90 does not change I/O
Bank Memory semantics, bundle commercial software, or track generated media.
...
[`m90_va_ems_board.md`](reports/m90_va_ems_board.md). G90 remains a human gate.
