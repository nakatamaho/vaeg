...
| M65 | tasks/M65_upd9002_residue_replan.md | Re-plan every G64 architectural failure and implementation-missing hash with non-overlapping owners; BRKEM remains corpus-deferred | **G65 not started; predecessor approval required** |
