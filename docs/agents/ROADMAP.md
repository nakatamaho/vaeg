...
| M85 | tasks/M85_state_save_section_cleanup.md | Audit retired state-save sections, remove only approved obsolete sections, and document compatibility behavior | **G85 human gate passed; M85 closed on the topic branch at candidate `a9a647966a12ca1959114c504aa87ac690e46693`; main merge pending** |
...
- M85 audits the current statsave.tbl inventory and preserves the VA,
  ...
  gate passed, and M85 is closed on the topic branch. The branch has not been
  merged to main by this record; M86 has not started.
...
closed on the topic branch. The branch is not merged to main by this record;
M86 has not started.
...
M85 is closed on the topic branch. The branch remains separate from main
until explicitly merged. M85-M88 define the remaining planned VA-only
source-tree
