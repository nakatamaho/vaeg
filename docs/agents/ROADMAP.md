...
| M98 | tasks/M98_zundamon_orbit_master_plan.md | Build an isolated 320x200 billboard-orbit demo around a generic local indexed-image input, a shared 30-scale single-bank BMS atlas, and deterministic 1-16 instance SGP composition | **G98 master gate remains pending; completed lettered-stage gates, absorbed reservations, and the next-stage assignment are tracked in the master task and stage reports** |
