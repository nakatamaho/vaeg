...
| M62 | tasks/M62_upd9002_semantics_bundle.md | One-time maintainer-approved bundle: correct AAM, ROR4, ROL4 activation, BCD/ASCII adjust, and shifts through independently reviewable phase commits | **G62 not started; predecessor approval required** |
