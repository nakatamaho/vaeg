...
| M97 | tasks/M97_sgp_tekumani_commands.md | Complete only manual-derived SGP descriptor, LINE, SCAN, ROP, and transparency semantics without timing or real-hardware claims | **M97 implementation in progress; G97 is a VAEG visual-regression gate** |
