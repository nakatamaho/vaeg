...
| M78 | tasks/M78_iova_to_io_reference_fixups.md | Normalize include paths, CMake source lists, and current documentation after the `iova` to `io` move | **G78 passed at `a86365584ffd86973b618bdaf55c26214798a1f0`; merged to `main`** |
...
- G78 passed at exactly
  `a86365584ffd86973b618bdaf55c26214798a1f0`. This is the M78 current-tree
  reference-normalization checkpoint. The candidate was validated from the
  current `main` base and is merged to `main`.
...
merged to `main`; M79 is next. M80 is not started.
