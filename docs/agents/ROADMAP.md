...
| M98 | tasks/M98_zundamon_orbit_master_plan.md | Build an isolated 320x200 billboard-orbit demo around a generic local indexed-image input, a shared 32-scale BMS atlas, and deterministic 1-16 instance SGP composition | **M98 reassigned to Zundamon orbit; G98a scope gate passed on 2026-08-31; M98b is the next stage** |
