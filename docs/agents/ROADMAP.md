...
| M55 | tasks/M55_hostfat_integration.md | Add PC-Engine-compatible FAT12-max HOSTFAT geometry, GUI/configuration, save-state identity, refresh policy, and hardened host-path handling | **G55 human; corrected implementation gate pending** |
