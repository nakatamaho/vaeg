...
| M90 | tasks/M90_va_ems_board.md | Enable the retained VA EMS page-frame board with 1MB capacity units, GUI/configuration support, and an EMMVA/RDEMS supplemental-disk workflow | **Implementation in progress; G90 human gate pending** |
...
M90 implementation and local validation are in progress. The final candidate
SHA and validation details will be recorded in
