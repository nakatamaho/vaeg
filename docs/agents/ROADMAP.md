...
| M97 | tasks/M97_sgp_tekumani_commands.md | Complete manual-derived SGP descriptor, LINE, SCAN, ROP, and transparency semantics and add an isolated LINE visual test without timing or real-hardware claims | **Extended candidate published; G97 VAEG visual-regression gate pending** |
