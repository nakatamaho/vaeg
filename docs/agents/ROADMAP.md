...
| M64 | tasks/M64_upd9002_div_idiv.md | Correct DIV/IDIV and complete requested monitor-authorized ADD4S/SUB4S/CMP4S, TEST1/NOT1/CLR1/SET1, and BRKEM support through separate phases | **G64 not started; predecessor approval required** |
