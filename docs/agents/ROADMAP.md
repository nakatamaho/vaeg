...
| M97 | tasks/M97_sgp_tekumani_commands.md | Complete only manual-derived SGP descriptor, LINE, SCAN, ROP, and transparency semantics without timing or real-hardware claims | **Candidate published; G97 VAEG visual-regression gate pending** |
