...
| M91 | tasks/M91_va_single_path.md | Remove retired PC-98 machine-mode routing and use one native V3 VA I/O, memory, CGROM, and initialization path | **G91 human gate pending** |
