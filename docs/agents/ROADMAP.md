...
- **PC-88VA active-tree invariant (M15, updated by M72).** The active
  ...
  PC-9821 guarded code, and treats `VAEG_EXT` as obsolete active-tree cleanup
  rather than a feature to enable blindly.
