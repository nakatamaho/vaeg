...
| M98 | tasks/M98_zundamon_orbit_master_plan.md | Build an isolated 320x200 billboard-orbit demo around a generic local indexed-image input, a shared 32-scale BMS atlas, and deterministic 1-16 instance SGP composition | **M98 reassigned to Zundamon orbit; G98a and G98e human gates and G98b-G98d and G98f-G98i machine gates passed on 2026-08-31; M98j candidate has `HOST_FIXTURE_PASS` and `LOCAL_HOST_PIPELINE_BLOCKED_FRAME_TOO_LARGE`; G98j is pending and M98k is unassigned** |
