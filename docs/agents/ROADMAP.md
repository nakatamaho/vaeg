...
| M60c | tasks/M60c_upd9002_fpo2_main_dispatch_audit.md | Audit the main dispatch and FPO2/66/67 target authority without changing instruction semantics | **G60c in progress; candidate not yet approved** |
