...
| M92 | tasks/M92_clang_format.md | Establish a pinned clang-format 22 policy and mechanically normalize the active first-party C/C++ source set | **IN PROGRESS; G92 pending** |
