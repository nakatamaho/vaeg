...
| M96 | tasks/M96_va_only_structural_cleanup.md | Audit and simplify the VA-only source tree in staged, evidence-backed cleanup stages while preserving live C-bus and VA hardware boundaries | **G96a passed; M96b ready** |
