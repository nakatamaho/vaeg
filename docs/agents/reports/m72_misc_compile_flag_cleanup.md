...
- SCSI and BMS are now unconditional active code paths instead of compile-time
  switches. This intentionally keeps the SCSI paths that were already present
  in the source list.
