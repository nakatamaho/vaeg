...
UPD9002_F6 _idiv_ea16(UINT op) {
	...
	tmp = (SINT32)((UPD9002_DX << 16) + UPD9002_AX);
	if (src) {
		r = tmp / src;
...
const UPD9002OPF6 c_ope0xf6_table[] = {
			_test_ea8_data8,	_test_ea8_data8,
			_not_ea8,			_neg_ea8,
			_mul_ea8,			_imul_ea8,
			_div_ea8,			_idiv_ea8};

const UPD9002OPF6 c_ope0xf7_table[] = {
